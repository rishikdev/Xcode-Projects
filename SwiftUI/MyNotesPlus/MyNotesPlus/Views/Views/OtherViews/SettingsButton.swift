    ...
    var body: some View {
        ...
        .sheet(isPresented: $isShowingSheet) {
            VStack {
                        ...
                        VStack {
                            Picker("View Style", selection: quickSettings.$viewStylePreference) {
                                ForEach(ViewStyleEnum.allCases, id: \.self) {
                                    Label("\($0.rawValue)", systemImage: $0.imageName)
                ...
                .onChange(of: quickSettings.isUsingBiometric) { isAppLocked in
...
struct SettingsButton_Previews: PreviewProvider {
    static var previews: some View {
        SettingsButton(myNotesViewModel: MyNotesViewModel(), quickSettings: QuickSettingsClass())
    }
}
