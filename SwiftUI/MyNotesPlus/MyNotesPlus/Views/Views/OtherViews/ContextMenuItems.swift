...
struct ContextMenuItems: View {
    ...
    var body: some View {
        Group {
            if(isCardView) {
                Menu("Change card") {
                    ForEach(["NoteCardYellowColour Yellow", "NoteCardGreenColour Green", "NoteCardPinkColour Pink"], id: \.self) { cardColour in
            ...
            Menu("Change tag") {
                ForEach(["🔴 Red", "🟢 Green", "🔵 Blue", "🟡 Yellow", "⚪️ White"], id: \.self) { buttonText in
